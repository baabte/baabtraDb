...
db.system.js.save({_id:"fnGetDraftedCourses",value:function(a){return db.clnCourses.find({companyId:a,draftFlag:0,activeFlag:1},{Name:1,Image:1,Description:1}).toArray()}});
