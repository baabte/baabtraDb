...
db.clnActiveUserData.createIndex( { "loginDate": 1 }, { expireAfterSeconds: 604800 } );
...
db.system.js.save({_id: "fnsaveAttendanceAlertSettings",
    ...
    if (userExistsOrNot == 0) {
        ...
        db.clnActiveUserData.update({userLoginId:user.userLoginId}, {$push:{ip_address:ip_address},$set:{"loginDate":user.loginDate}});
        db.clnLoginHistory.insert(user);
